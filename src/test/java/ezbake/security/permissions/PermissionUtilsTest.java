...
public class PermissionUtilsTest {
    @Test
    public void testGetPermissionsAll() throws Exception {
        final Visibility visibility = createVisibility();

        final Authorizations auths =
                createAuths(Sets.newHashSet("U", "C", "S", "TS", "USA"), Sets.newHashSet("Foo", "Bar"),
    ...
    @Test
    public void testGetPermissionsReadDiscover() throws Exception {
        final Visibility visibility = createVisibility();
        ...
        assertEquals(EnumSet.of(Permission.READ, Permission.DISCOVER),
    ...
    @Test
    public void testGetPermissionsNoPerms() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testGetPermissionsExternalCommunityMismatch() throws Exception {
        final Visibility visibility = createVisibility();

        // Remove required auth
        final Authorizations auths =
                createAuths(Sets.newHashSet("U", "C", "S", "TS", "USA"), Sets.newHashSet("Foo"),
                        Sets.newHashSet(3L, 56L, 2785L, 123876592237L));
    ...
    @Test
    public void testGetPermissionsFormalAuthsMismatch() throws Exception {
        final Visibility visibility = createVisibility();

        final Authorizations auths =
                createAuths(Sets.newHashSet("U"), Sets.newHashSet("Foo", "Bar"),
                        Sets.newHashSet(3L, 56L, 2785L, 123876592237L));
    ...
    @Test
    public void testGetPermissionsSubset() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testNullVisibility() throws Exception {
        final Authorizations auths =
                createAuths(Sets.newHashSet("U", "C", "S", "TS", "USA"), Sets.newHashSet("Foo", "Bar"),
                        Sets.newHashSet(3L, 56L, 2785L, 123876592237L));
    ...
    @Test
    public void testNullAuths() throws Exception {
        final Visibility visibility = createVisibility();
        assertEquals(NO_PERMS, PermissionUtils.getPermissions(null, visibility, true));
    }

    @Test
    public void testEmptyFormalVisibility() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testEmptyFormalAuths() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testNullMarkings() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testNullPlatformObjectVisibilities() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testNullPlatformObjectAuths() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    @Test
    public void testEmptyPlatformObjectAuths() throws Exception {
        final Visibility visibility = createVisibility();
        visibility.getAdvancedMarkings().setPlatformObjectVisibility(
                new PlatformObjectVisibilities()
                        .setPlatformObjectDiscoverVisibility(Collections.<Long>emptySet())
    ...
    @Test
    public void testNullPlatformObjectAuthsAndNullLeafVisibilities() throws Exception {
        final Visibility visibility = createVisibility();
    ...
    public void testValidateFormalAuths() {
        ...
        assertTrue(PermissionUtils
                .validateVisibilityExpression(Sets.newHashSet("U", "C", "S", "TS", "USA"), "TS&USA"));
    ...
    public void testGenerateExpression_OnlyFormal() {
        final Visibility visibility = new Visibility().setFormalVisibility("TS&SI&TK");
        assertEquals("TS&SI&TK", PermissionUtils.getVisibilityString(visibility));
    }

    @Test
    public void testGenerateExpression_OnlyExternal() {
        final Visibility visibility =
                new Visibility().setAdvancedMarkings(new AdvancedMarkings()
                        .setExternalCommunityVisibility("COM1&COM2"));
    ...
    public void testGenerateExpression_BothStrings() {
        final Visibility visibility =
                new Visibility().setFormalVisibility("TS&SI&TK").setAdvancedMarkings(
                        new AdvancedMarkings().setExternalCommunityVisibility("COM1&COM2"));

        assertEquals("(TS&SI&TK)&(COM1&COM2)", PermissionUtils.getVisibilityString(visibility));
    }

    @Test
    public void testGenerateExpression_FormalIsEmpty() {
        final Visibility visibility =
                new Visibility().setFormalVisibility("").setAdvancedMarkings(
                        new AdvancedMarkings().setExternalCommunityVisibility("COM1&COM2"));
