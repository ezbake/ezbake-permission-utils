...
public class PermissionUtils {
    ...
    public static Set<Permission> getPermissions(Authorizations auths, Visibility visibility,
        ...
        if (validateFormalAuths
                && !validateVisibilityExpression(auths.getFormalAuthorizations(), visibility.getFormalVisibility())) {
        ...
        for (final Permission permToCheck : subsetToCheck) {
            ...
            if (permVisibility == null || permVisibility.isEmpty() || authCheck != null
                    && !Sets.intersection(authCheck, permVisibility).isEmpty()) {
    ...
    public static boolean validateVisibilityExpression(Set<String> auths, String visibilityExpression) {
        if (StringUtils.isEmpty(visibilityExpression)) {
        ...
        final VisibilityEvaluator visEval =
                new VisibilityEvaluator(new org.apache.accumulo.core.security.Authorizations(
     ...
     * @return the visibility expression computed from both the formal visibility string and community visibility
     *         string
     */
