...
public class PermTestHelpers {
    public static PlatformObjectVisibilities createPlatformObjectVisibilities() throws IOException {
    ...
    public static AdvancedMarkings createAdvancedMarkings() throws IOException {
    ...
    public static Visibility createVisibility() throws IOException {
    ...
    public static Authorizations createAuths(Set<String> formalAuths, Set<String> externalCommunityAuths,
            Set<Long> platformObjectAuths) throws IOException {
